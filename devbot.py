...
if choice.lower() == 'n':
	...
	accessToken = "Bearer <!NzJiYjc2NzAtZDA0Yi00YzhlLWFiOWUtZTJlYjFlNzI3OGM0NDZlOTQ5NjYtY2I2_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0>"
...
rooms = r.json()["items"]
for room in rooms:
     print("Type: {}, Title: {}".format(room["type"], room["title"]))
#######################################################################################
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "<rQa6EA4yGNbQ6MoHf0RcLFmRiosycyYZ>"
                               }
...
# 10. Provide the Sunrise/Sunset key value for day_length.
        dayLengthSeconds = 786 seconds
        sunriseTime = 07:15:09 AM
        sunsetTime =  05:02:53 PM
...
# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
            "Authorization": <NzJiYjc2NzAtZDA0Yi00YzhlLWFiOWUtZTJlYjFlNzI3OGM0NDZlOTQ5NjYtY2I2_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0>,
            "Content-Type": "application/json"
        }
        PostData = {
            "roomId": <Y21zY29zcGFyazOvL3VybjpURUFNOnVzLXd1c3QtMl9yL1>,
            "text": <Hello Room!>
                   }
